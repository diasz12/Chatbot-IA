...
def selecionar_persona(mensagem_usuario):
    prompt_sistema = """
        Faça uma análise da mensagem informada abaixo para identificar se o sentimento é: 
        positivo, neutro ou negativo. Retorne apenas um dos três tipos de sentimentos como 
        resposta: "positivo", "neutro", ou "negativo". Não inclua explicações adicionais.
    """
